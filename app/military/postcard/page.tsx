      ...
      <main className="min-h-screen bg-gradient-to-b from-[#34c5c5]/10 via-[#F6F8FA] to-white">
        <section className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 pt-12 md:pt-16 pb-16 md:pb-20">
          ...
          <p className="text-sm text-gray-500 mb-10">
            Jump to <a href="#postcards" className="text-[#0D9488] font-bold hover:underline">Postcards (4×5)</a> ·{' '}
            <a href="#flyers" className="text-[#0D9488] font-bold hover:underline">Flyers (8.5×11)</a>
          </p>

          <MarketingKit primary="postcard" />
        </section>
      </main>
      <Footer />
    </>
