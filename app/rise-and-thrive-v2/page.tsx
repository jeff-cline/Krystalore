...
export default function RiseAndThriveV2() {
  return (
    <>
      <Header />
            ...
            <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-6">
              {components.map((c) => (
                <div key={c.label} className="bg-white rounded-3xl overflow-hidden shadow-sm border border-gray-100">
                  <div className="relative h-36"><Image src={c.img} alt={c.label} fill className="object-cover" sizes="(max-width:1024px) 50vw, 25vw" /></div>
                  <div className="p-5">
        ...
        <section id="offer" className="py-16 md:py-24 bg-white">
          <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div className="grid md:grid-cols-2 gap-7 items-stretch">
              ...
              {/* VIP */}
              <div className="bg-gray-900 rounded-3xl p-8 md:p-9 shadow-2xl flex flex-col relative overflow-hidden">
                ...
                <p className="text-gray-400 mb-6">Everything in The Bundle — plus the deepest support.</p>
