...
const faqs = [
  ...
  { question: 'How is this different from other fitness programs?', answer: 'Most fitness programs focus only on the body. Million Dollar Body integrates training, nutrition, AND mindset — because sustainable transformation requires all three. Krystalore brings real-world experience from 28 marathons, NFL cheerleading, and overcoming a wheelchair-bound injury.' },
...
export default function MillionDollarBodyPage() {
  return (
    <>
      <JsonLd />
      <Header />
      <DynamicHeader slug="million-dollar-body"
        fallbackTitle="Million Dollar Body"
