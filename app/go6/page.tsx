...
export default function Go4Page() {
  ...
  const serviceCards = [
    { title: "Fitness", image: "/images/go6/beach-balloon-fitness.jpg", desc: "HIIT, kickboxing, and functional training to push your body and sharpen your mind.", link: "/fitness" },
    { title: "Speaking & Keynotes", image: "/images/go6/wny-heroes-speaking.jpg", desc: "Powerful keynotes on leadership, resilience, and transformation for your next event.", link: "/keynote-speaker" },
    { title: "Corporate Retreats", image: "/images/go6/poolside-pink-chair.jpg", desc: "Custom retreat experiences that build trust, alignment, and high-performance culture.", link: "/corporate-retreat-planning" },
    { title: "Private Coaching", image: "/images/go6/floor-journaling.jpg", desc: "One-on-one experiential coaching for leaders ready to transform every area of life.", link: "/private" },
    { title: "Books", image: "/images/go6/planner-closeup.jpg", desc: "Amazon best-selling books, the Krystal Clear Life Planner, Men's Tactical Life Planner, and the Road to Resilience.", link: "/books" },
    { title: "Podcasts", image: "/images/go6/tropical-porch-dress.jpg", desc: "Real conversations on healing, leadership, and building a life beyond limits.", link: "/podcasts" },
    { title: "Courses", image: "/images/go6/umbrella-dress.jpg", desc: "Self-paced and live courses on leadership, emotional intelligence, and wellness.", link: "/courses" },
    { title: "Veteran Programs", image: "/images/go6/couple-ocean-balloon.jpg", desc: "Specialized coaching and fitness programs honoring those who served.", link: "/veteran-coaching" },
    { title: "Gypsy Tours", image: "/images/go6/lobster-dinner-1.jpg", desc: "Curated travel experiences that combine adventure, wellness, and transformation.", link: "/gypsy-tours" },
    { title: "Beyond Limits Boot Camp", image: "/images/go6/beach-gold-balloon.jpg", desc: "Live virtual fitness Mon/Wed/Fri with 24/7 replay access. HIIT, kickboxing, and accountability.", link: "/bootcamp" },
    { title: "Corporate Wellness & Leadership", image: "/images/go6/retreat-group-stairs.jpg", desc: "Elevate your team's performance with customized corporate wellness and leadership development programs.", link: "/corporate-wellness" },
    { title: "Coworking Power Hour", image: "/images/go6/floor-journaling-wide.jpg", desc: "Free weekly co-working sessions on Zoom. Show up, get focused, get it done.", link: "/coworking" },
    { title: "Retreats", image: "/images/go6/spa-relaxation.jpg", desc: "Transformative retreat experiences for women, veterans, entrepreneurs, and couples.", link: "/retreat" },
    { title: "Shop", image: "/images/go6/tropical-porch-2.jpg", desc: "Apparel, merchandise, wellness products, and the Tropical Memories dress shop.", link: "/shop" },
    { title: "Business Boot Camp", image: "/images/go6/wny-heroes-speaking.jpg", desc: "Startup incubator to scale-up accelerator. Build, launch, and grow your business.", link: "/business-bootcamp" },
    { title: "Nonprofit", image: "/images/go6/retreat-group-stairs.jpg", desc: "Supporting veterans, female business owners, and Roatan community nonprofits through service and impact.", link: "/nonprofit" },
    { title: "Real Estate & Investments", image: "/images/go6/lobster-dinner-2.jpg", desc: "Global real estate opportunities and investment partnerships for portfolio growth.", link: "/real-estate" },
    { title: "Bombshell Boot Camp", image: "/images/go6/beach-balloon-fitness.jpg", desc: "Online monthly course teaching the Freedom Formula — build unstoppable confidence from the inside out.", link: "/bombshell-bootcamp" },
    { title: "Vision Board Workshops", image: "/images/go6/floor-journaling-wide2.jpg", desc: "Quarterly or on-request workshops for teams, communities, and retreats. Strategic planning, goal setting, and accountability.", link: "/vision-board" },
    { title: "Million Dollar Body Academy", image: "/images/go6/beach-gold-balloon.jpg", desc: "The signature course for building the body and mindset of a champion. Transform from the inside out.", link: "/million-dollar-body" },
    { title: "Upcoming Events", image: "/images/go6/poolside-pink-chair.jpg", desc: "In-person, live, and virtual events and experiences. See what's next and join us.", link: "/upcoming-events" },
    { title: "Partners", image: "/images/go6/retreat-group-stairs.jpg", desc: "Strategic partnerships, collaboration opportunities, and joint ventures.", link: "/partners" },
  ]

  const fiveCCards = [
    {
      title: "Core",
      image: "/images/go6/floor-journaling.jpg",
    ...
    {
      title: "Confidence",
      image: "/images/go6/umbrella-dress.jpg",
    ...
    {
      title: "Consistency",
      image: "/images/go6/beach-balloon-fitness.jpg",
    ...
    {
      title: "Community",
      image: "/images/go6/poolside-pink-chair.jpg",
    ...
    {
      title: "Celebration",
      image: "/images/go6/spa-relaxation.jpg",
  ...
  const productivityTools = [
    {
      ...
      image: "/images/go6/floor-journaling-wide.jpg",
    ...
    },
    {
      ...
      image: "/images/go6/planner-closeup.jpg",
  ...
  const memberships = [
    {
      ...
      price: "FREE",
      priceNote: "",
      image: "/images/go6/retreat-group-stairs.jpg",
    ...
    },
    {
      ...
      price: "$89-109",
      priceNote: "/mo",
      image: "/images/go6/beach-gold-balloon.jpg",
  ...
  return (
    <div className="min-h-screen bg-white">
      ...
      <section className="relative overflow-hidden">
        <Image
          src="/images/go6/lobster-dinner-4.jpg"
          ...
          <div className="flex flex-col lg:flex-row items-center gap-8 lg:gap-16 max-w-7xl mx-auto py-16 lg:py-24">
            <div className="flex-1 text-center lg:text-left">
              ...
              <div className="flex items-center gap-4 mt-12 justify-center lg:justify-start">
                ...
                <Image 
                  src="/images/go6/beach-balloon-fitness.jpg" 
          ...
          <div className="max-w-7xl mx-auto">
            <div className="flex flex-col lg:flex-row gap-12 items-center mb-16">
              <div className="relative rounded-2xl overflow-hidden shadow-2xl max-w-md aspect-[3/4] flex-shrink-0">
                <Image src="/images/go6/beach-balloon-fitness.jpg" alt="Krystalore Crews" fill className="object-cover" />
              </div>
        ...
        <div className="max-w-6xl mx-auto">
          <div className="grid lg:grid-cols-2 gap-0 items-stretch rounded-2xl overflow-hidden shadow-xl">
            <div className="relative min-h-[500px] lg:min-h-[600px]">
              <Image
                src="/images/go6/wny-heroes-speaking.jpg"
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-start">
            <div>
              ...
              <div className="relative h-64 rounded-2xl overflow-hidden mb-8 shadow-lg">
                <Image
                  src="/images/go6/spa-relaxation.jpg"
            ...
            <div className="space-y-4">
              ...
              {[
                { icon: Heart, title: 'Movement: Healing in Motion', desc: 'Guided movement practices that help release stored tension and reconnect you with your body\'s wisdom.', color: 'text-[#E8A849]', img: '/images/go6/floor-journaling-wide.jpg' },
                { icon: Brain, title: 'Compassionate Inquiry', desc: 'A gentle, trauma-informed approach to uncovering the root causes of emotional and physical patterns.', color: 'text-[#34c5c5]', img: '/images/go6/spa-relaxation.jpg' },
                { icon: TreePine, title: 'Mindfulness Integration', desc: 'Present-moment awareness practices that build resilience and emotional regulation.', color: 'text-[#84d7d7]', img: '/images/go6/tropical-porch-dress.jpg' },
                { icon: Mountain, title: 'Retreats: Immersive Healing', desc: 'Immersive retreat experiences designed for deep somatic work in transformational settings.', color: 'text-[#84d7d7]', img: '/images/go6/couple-ocean-balloon.jpg' },
            ...
            <div className="grid grid-cols-2 gap-4">
              <div className="space-y-4">
                <div className="relative h-72 rounded-2xl overflow-hidden shadow-lg">
                  <Image src="/images/go6/umbrella-dress.jpg" alt="Krystalore Crews executive coach" fill className="object-cover" sizes="(max-width: 768px) 50vw, 25vw" />
                </div>
                <div className="relative h-64 rounded-2xl overflow-hidden shadow-lg">
                  <Image src="/images/go6/retreat-group-stairs.jpg" alt="Womens somatic healing retreat" fill className="object-cover" sizes="(max-width: 768px) 50vw, 25vw" />
                </div>
              </div>
              <div className="pt-8">
                <div className="relative h-80 rounded-2xl overflow-hidden shadow-lg">
                  <Image src="/images/go6/beach-balloon-fitness.jpg" alt="Krystalore Crews fitness coaching" fill className="object-cover" sizes="(max-width: 768px) 50vw, 25vw" />
                </div>
              </div>
            </div>
          </div>
      ...
      <section className="py-20 px-4 bg-[#37a6a6]" id="content">
        <div className="max-w-6xl mx-auto">
          ...
          <div className="grid md:grid-cols-3 gap-6">
            {[
              { title: 'Monday Motivation LIVE', subtitle: 'Weekly Highlight', desc: 'Start your week with fire. Mindset, motivation, and real talk to push you forward.', icon: Play, img: '/images/go6/beach-gold-balloon.jpg' },
              { title: 'Most People Quit Right Before It Gets Good', subtitle: 'Mindset Shift', desc: 'The breakthrough is closer than you think. Don\'t quit now—the best chapter is next.', icon: Flame, img: '/images/go6/umbrella-dress.jpg' },
              { title: 'What Does All In Look Like?', subtitle: 'Going Deeper', desc: 'Going all in isn\'t about burning out—it\'s about alignment, focus, and relentless intentionality.', icon: Target, img: '/images/go6/lobster-dinner-1.jpg' },
            ...
            <div>
              ...
              <div className="bg-[#F4F1EC] rounded-2xl overflow-hidden shadow-md mb-6">
                <div className="relative h-56">
                  <Image src="/images/go6/floor-journaling.jpg" alt="Strong sexy leg workouts at home" fill className="object-cover" sizes="(max-width: 1024px) 100vw, 50vw" />
                </div>
                <div className="p-6">
      ...
      <section className="py-20 px-4 bg-[#F4F1EC]" id="corporate">
        <div className="max-w-6xl mx-auto">
          ...
          <div className="grid md:grid-cols-3 gap-6 mb-12">
            <div className="relative h-64 rounded-2xl overflow-hidden shadow-lg">
              <Image src="/images/go6/couple-ocean-balloon.jpg" alt="Leadership retreats with Krystalore Crews" fill className="object-cover" sizes="(max-width: 768px) 100vw, 33vw" />
              <div className="absolute inset-0 bg-gradient-to-t from-gray-900/60 to-transparent" />
              <p className="absolute bottom-4 left-4 text-white font-bold text-sm">Leadership Retreats</p>
            </div>
            <div className="relative h-64 rounded-2xl overflow-hidden shadow-lg">
              <Image src="/images/go6/retreat-group-stairs.jpg" alt="Corporate wellness workshops" fill className="object-cover" sizes="(max-width: 768px) 100vw, 33vw" />
              <div className="absolute inset-0 bg-gradient-to-t from-gray-900/60 to-transparent" />
              <p className="absolute bottom-4 left-4 text-white font-bold text-sm">Corporate Wellness</p>
            </div>
            <div className="relative h-64 rounded-2xl overflow-hidden shadow-lg">
              <Image src="/images/go6/wny-heroes-speaking.jpg" alt="Keynote speaking and corporate events" fill className="object-cover" sizes="(max-width: 768px) 100vw, 33vw" />
              <div className="absolute inset-0 bg-gradient-to-t from-gray-900/60 to-transparent" />
      ...
      <section className="py-20 px-4 bg-white" id="media">
        <div className="max-w-6xl mx-auto">
          ...
          <div className="grid md:grid-cols-2 gap-8 mb-12 max-w-3xl mx-auto">
            <div className="relative h-72 rounded-2xl overflow-hidden shadow-lg">
              <Image src="/images/go6/poolside-pink-chair.jpg" alt="Krystalore Crews speaking at a leadership and wellness event" fill className="object-cover" sizes="(max-width: 768px) 100vw, 384px" />
            </div>
            <div className="relative h-72 rounded-2xl overflow-hidden shadow-lg">
              <Image src="/images/go6/tropical-porch-2.jpg" alt="Krystalore Crews press and media professional photo" fill className="object-cover" sizes="(max-width: 768px) 100vw, 384px" />
            </div>
          </div>
        ...
        <div className="max-w-6xl mx-auto">
          ...
          <div className="grid md:grid-cols-3 gap-4 mb-10">
            <div className="relative h-64 rounded-xl overflow-hidden shadow-md">
              <Image src="/images/go6/spa-relaxation.jpg" alt="Wellness lifestyle and self-care products" fill className="object-cover" sizes="(max-width: 768px) 100vw, 33vw" />
              <div className="absolute inset-0 bg-gradient-to-t from-gray-900/50 to-transparent" />
              <p className="absolute bottom-3 left-3 text-white font-bold text-sm">Wellness Collection</p>
            </div>
            <div className="relative h-64 rounded-xl overflow-hidden shadow-md">
              <Image src="/images/go6/tropical-porch-dress.jpg" alt="Beyond Limits lifestyle and activewear" fill className="object-cover" sizes="(max-width: 768px) 100vw, 33vw" />
              <div className="absolute inset-0 bg-gradient-to-t from-gray-900/50 to-transparent" />
              <p className="absolute bottom-3 left-3 text-white font-bold text-sm">Lifestyle</p>
            </div>
            <div className="relative h-64 rounded-xl overflow-hidden shadow-md">
              <Image src="/images/go6/couple-ocean-balloon.jpg" alt="Beyond Limits merchandise and apparel" fill className="object-cover" sizes="(max-width: 768px) 100vw, 33vw" />
              <div className="absolute inset-0 bg-gradient-to-t from-gray-900/50 to-transparent" />
