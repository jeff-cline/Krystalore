...
export default function Go4Page() {
  ...
  const serviceCards = [
    ...
    { title: "Beyond Limits Boot Camp", image: "/images/go6/beach-gold-balloon.jpg", desc: "Live virtual fitness with 24/7 replay access. HIIT, kickboxing, and accountability.", link: "/bootcamp" },
