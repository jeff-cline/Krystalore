...
export default function Go9Page() {
  const services = [
  ...
  const serviceCards = [
    ...
    { title: "Beyond Limits Boot Camp", image: "/images/go9/fitness-alt.jpg", desc: "Live virtual fitness with 24/7 replay access. HIIT, kickboxing, and accountability.", link: "/bootcamp" },
            ...
            <div className="grid grid-cols-2 gap-4">
              <div className="space-y-4">
                <div className="relative h-72 rounded-2xl overflow-hidden shadow-lg">
                  <Image src="/images/go9/portrait.jpg" alt="Krystalore Crews executive coach" fill className="object-cover" sizes="(max-width: 768px) 50vw, 25vw" />
                </div>
