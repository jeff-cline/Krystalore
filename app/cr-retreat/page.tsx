...
const carouselImages = [
  { src: '/images/retreat-destinations/cr-01.jpg', alt: 'Lush Costa Rica retreat property surrounded by tropical greenery', caption: 'A Tropical Revival Setting' },
  { src: '/images/retreat-destinations/cr-02.jpg', alt: 'Costa Rica retreat home with inviting indoor and outdoor living spaces', caption: 'Beautiful Shared Spaces' },
  { src: '/images/retreat-destinations/cr-03.jpg', alt: 'Costa Rica retreat bedroom prepared for rest and restoration', caption: 'Restorative Retreat Rooms' },
  { src: '/images/retreat-destinations/cr-04.jpg', alt: 'Costa Rica retreat pool and outdoor lounge area', caption: 'Poolside Reset Time' },
  { src: '/images/retreat-destinations/cr-05.jpg', alt: 'Costa Rica retreat dining and gathering space', caption: 'Connection Around the Table' },
  { src: '/images/retreat-destinations/cr-06.jpg', alt: "Costa Rica tropical property details for a women's retreat", caption: 'Lush, Peaceful Details' },
]

/* ─── 7-Day Itinerary ─── */
const itinerary = [
  { day: 'Day 1', title: 'Arrival & Grounding', icon: Sunrise, desc: 'Arrive in lush Costa Rica and settle into the retreat property. Meet your fellow retreat sisters, enjoy a welcome dinner, and set your intentions for the revival week ahead.' },
  { day: 'Day 2', title: 'Mind Reset & Movement', icon: Dumbbell, desc: 'Begin the morning with movement, breath, and mindset work in a tropical setting. Release what has felt heavy and reconnect with the woman you are becoming.' },
  { day: 'Day 3', title: 'Adventure & Discovery', icon: Mountain, desc: "Step into Costa Rica's natural beauty with an adventure day designed to wake up your joy, courage, and sense of possibility." },
  { day: 'Day 4', title: 'Deep Healing & Clarity', icon: Heart, desc: 'Move through guided coaching, reflection, and rest. This is the day to listen deeply, find clarity, and map what your next season is asking of you.' },
  { day: 'Day 5', title: 'Strength & Strategy', icon: Crown, desc: 'Blend energizing movement with life, leadership, and purpose strategy. Build the blueprint for what you are taking home — not just inspiration, but action.' },
  { day: 'Day 6', title: 'Radiance & Renewal', icon: Sparkles, desc: 'Celebrate the woman who showed up for herself. Expect sisterhood, photos, laughter, reflection, and a powerful celebration dinner.' },
  { day: 'Day 7', title: 'Integration & Departure', icon: Waves, desc: 'Close the retreat with integration, gratitude, and a grounded plan for what comes next. Leave renewed, clear, and ready to rise.' },
]
  ...
  return (
    <div className="min-h-screen bg-white text-gray-900">
      ...
      <DynamicHeader slug="cr-retreat"
        ...
        fallbackDate="October 18–25, 2026"
        fallbackImage="/images/retreat-destinations/cr-01.jpg"
        alt="Women gathering for a luxury Costa Rica Revive and Thrive retreat">
        ...
        <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid md:grid-cols-3 gap-6">
            ...
            <div className="bg-gray-50 rounded-2xl p-6 border border-gray-100 shadow-sm hover:shadow-lg transition-shadow">
              ...
              <h3 className="text-2xl font-bold mb-3">Costa Rica Retreat Updates</h3>
              <p className="text-gray-600 mb-5">Get first notice for room releases, checkout details, and Costa Rica retreat updates.</p>
      ...
      <section className="py-16 md:py-24 bg-white">
        <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            <p className="text-teal font-semibold tracking-widest uppercase text-sm mb-3">Your Tropical Reset</p>
            <h2 className="text-3xl md:text-4xl font-bold mb-4">
              Costa Rica Tropical Retreat Property
            </h2>
            <p className="text-gray-500 text-lg max-w-2xl mx-auto">
              A lush Costa Rica retreat property designed for tropical restoration, deep connection, and a powerful Revive & Thrive reset
            </p>
          </div>
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-6 mt-10">
            {[
              { icon: Home, label: 'Private Lodging', sub: 'Restorative retreat rooms' },
              { icon: Users, label: 'Intimate Group', sub: 'Sisterhood-focused setting' },
              { icon: Waves, label: 'Pool + Rest', sub: 'Space to reset' },
              { icon: Star, label: 'Revive Energy', sub: 'Designed for renewal' },
            ].map((item, i) => (
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <div>
              <p className="text-teal font-semibold tracking-widest uppercase text-sm mb-3">
                <MapPin className="w-4 h-4 inline mr-1" /> Costa Rica
              </p>
              <h2 className="text-3xl md:text-4xl font-bold mb-6">
                Where Restoration Meets Adventure
              </h2>
              <div className="space-y-4 text-gray-600 text-lg leading-relaxed">
                <p>
                  This Costa Rica retreat setting gives you room to breathe, reset, and reconnect with yourself away from the rush of everyday life.
                </p>
                <p>
                  Wake up surrounded by lush tropical beauty, move through the day with intention, and enjoy a retreat setting that helps your nervous system exhale.
                </p>
                <p>
              ...
              <div className="mt-8 grid grid-cols-2 gap-4">
                {[
                  { icon: Bed, text: 'Retreat Lodging' },
                  { icon: Bath, text: 'Comfortable Amenities' },
                  { icon: Waves, text: 'Pool + Relaxation' },
                  { icon: Utensils, text: 'Nourishing Meals' },
                  { icon: Wind, text: 'Tropical Air' },
            ...
            <div className="relative">
              <div className="rounded-2xl overflow-hidden shadow-xl">
                <Image
                  src="/images/retreat-destinations/cr-04.jpg"
                  alt="Costa Rica retreat outdoor pool and relaxation space"
                  width={600}
                  height={450}
              ...
              <div className="absolute -bottom-6 -left-6 rounded-xl overflow-hidden shadow-lg w-48 h-48 border-4 border-white">
                <Image
                  src="/images/retreat-destinations/cr-05.jpg"
                  alt="Costa Rica retreat gathering and dining space"
                  fill
                  className="object-cover"
                />
              </div>
        ...
        <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
            {[
              ...
              { icon: Home, title: 'Luxury Accommodations', desc: 'Beautiful retreat lodging and gathering spaces designed to help you fully unwind.' },
              ...
              { icon: Sunrise, title: 'Tropical Mornings', desc: 'Wake up in Costa Rica with space, beauty, and permission to put yourself first.' },
              ...
              { icon: TreePine, title: 'Costa Rica Adventure', desc: 'Step into your bold, adventurous self with Costa Rica experiences designed to reconnect you with joy.' },
        ...
        <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            <div className="rounded-2xl overflow-hidden shadow-lg">
              <Image src="/images/retreat-destinations/cr-02.jpg" alt="Women in matching retreat shirts posing on tropical beach" width={400} height={300} className="w-full h-64 object-cover" />
            </div>
            <div className="rounded-2xl overflow-hidden shadow-lg">
              <Image src="/images/retreat-destinations/cr-01.jpg" alt="Retreat women celebrating at sunset with ocean views" width={400} height={300} className="w-full h-64 object-cover" />
            </div>
            <div className="rounded-2xl overflow-hidden shadow-lg">
              <Image src="/images/retreat-destinations/cr-03.jpg" alt="Women running together during retreat fitness activity" width={400} height={300} className="w-full h-64 object-cover" />
            </div>
          </div>
        </div>
      </section>
        ...
        <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <div className="relative">
              <div className="rounded-2xl overflow-hidden shadow-xl">
                <Image
                  src="/images/retreat-destinations/cr-06.jpg"
      ...
      <section className="relative py-24 md:py-32 overflow-hidden">
        <Image
          src="/images/retreat-destinations/cr-02.jpg"
          alt="Costa Rica retreat setting for women's wellness and revival"
          fill
          className="object-cover"
          sizes="100vw"
        />
        ...
        <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="space-y-6">
            {[
              ...
              { q: 'Where is the retreat located?', a: 'The retreat takes place at a beautiful Costa Rica property chosen for tropical restoration, coaching, movement, sisterhood, and adventure. Final arrival airport and transportation recommendations will be shared with registered guests.' },
              { q: 'What\'s included in the retreat?', a: 'Everything is all-inclusive once you arrive: luxury retreat lodging, all meals prepared by a private chef, daily coaching sessions, fitness and yoga classes, spa treatments, a Costa Rica adventure, butler service, and daily surprises. Flights are not included.' },
              ...
              { q: 'What airport should I fly into?', a: 'Final flight and airport guidance will be provided with registration details so guests can plan transportation confidently.' },
      ...
      <script
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            ...
            description: 'A 7-day luxury wellness retreat for high-achieving women in Costa Rica. Includes transformational coaching, fitness, adventure, spa treatments, and private chef cuisine at a stunning Costa Rica oceanview estate in the Costa Rica Rainforest.',
            url: 'https://krystalore.com/pr-retreat',
            eventAttendanceMode: 'https://schema.org/OfflineEventAttendanceMode',
            eventStatus: 'https://schema.org/EventScheduled',
            location: {
              '@type': 'Place',
              name: 'Costa Rica Tropical Retreat Property',
              address: {
                '@type': 'PostalAddress',
            ...
            image: 'https://krystalore.com/images/retreat-destinations/cr-01.jpg',
            keywords: 'women\'s retreat, wellness retreat, business retreat for women, luxury retreat Costa Rica, women\'s empowerment retreat, executive wellness retreat, transformational coaching retreat',
          }),
        }}
      />
      <script
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            ...
            mainEntity: [
              ...
              { '@type': 'Question', name: 'Where is the Revive & Thrive retreat located?', acceptedAnswer: { '@type': 'Answer', text: 'The retreat takes place at a beautiful Costa Rica retreat property selected for restoration, movement, sisterhood, and adventure.' } },
              { '@type': 'Question', name: 'What\'s included in the retreat?', acceptedAnswer: { '@type': 'Answer', text: 'Everything is all-inclusive: luxury accommodations, private chef meals, daily coaching, fitness, spa treatments, Costa Rica adventure, butler service. Flights not included.' } },
