...
const STAGES = [
  { n: 1, tier: 'Discover · Free', time: 'Day 1 · Free', color: '#34c5c5', pos: { l: 8, t: 82 }, items: [
  ...
  { n: 3, tier: 'Core Programs', time: 'Months 1–3', color: '#E8A849', pos: { l: 63, t: 38 }, items: [
    { label: 'Health Mastery', href: '/health-mastery' },
    { label: 'Beyond Limits Bootcamp', href: '/bootcamp' },
    { label: 'Courses', href: '/courses' },
  ] },
  { n: 4, tier: 'Premium · VIP', time: '90 Days · Premium', color: '#e07800', pos: { l: 86, t: 15 }, items: [
  ...
  return (
    <div className="rounded-2xl bg-white shadow-xl border border-gray-100 p-4 w-[200px]">
      ...
      <ul className="space-y-0.5">
        {s.items.map((i) => (
          <li key={i.label} className="text-[11px] leading-snug">
            {(i as any).ext
