...
export default function Go7Page() {
  const services = [
  ...
  const serviceCards = [
    { title: "Fitness", image: "/images/go7/fitness.png", desc: "HIIT, kickboxing, and functional training to push your body and sharpen your mind.", link: "/fitness" },
    { title: "Speaking & Keynotes", image: "/images/go7/keynote.png", desc: "Powerful keynotes on leadership, resilience, and transformation for your next event.", link: "/keynote-speaker" },
    { title: "Corporate Retreats", image: "/images/go7/corporate.png", desc: "Custom retreat experiences that build trust, alignment, and high-performance culture.", link: "/corporate-retreat-planning" },
    { title: "Private Coaching", image: "/images/go7/coaching.png", desc: "One-on-one experiential coaching for leaders ready to transform every area of life.", link: "/private" },
    { title: "Books", image: "/images/go7/portrait.png", desc: "Amazon best-selling books, the Krystal Clear Life Planner, Men's Tactical Life Planner, and the Road to Resilience.", link: "/books" },
    { title: "Podcasts", image: "/images/go7/hero.png", desc: "Real conversations on healing, leadership, and building a life beyond limits.", link: "/podcasts" },
    ...
    { title: "Shop", image: "/images/go7/portrait.png", desc: "Apparel, merchandise, wellness products, and the Tropical Memories dress shop.", link: "/shop" },
    { title: "Business Boot Camp", image: "/images/go7/keynote.png", desc: "Startup incubator to scale-up accelerator. Build, launch, and grow your business.", link: "/business-bootcamp" },
    { title: "Nonprofit", image: "/images/go7/group.png", desc: "Supporting veterans, female business owners, and Roatan community nonprofits through service and impact.", link: "/nonprofit" },
    { title: "Real Estate & Investments", image: "/images/go7/corporate.png", desc: "Global real estate opportunities and investment partnerships for portfolio growth.", link: "/real-estate" },
    { title: "Bombshell Boot Camp", image: "/images/go7/fitness.png", desc: "Online monthly course teaching the Freedom Formula — build unstoppable confidence from the inside out.", link: "/bombshell-bootcamp" },
    { title: "Vision Board Workshops", image: "/images/go7/coaching.png", desc: "Quarterly or on-request workshops for teams, communities, and retreats. Strategic planning, goal setting, and accountability.", link: "/vision-board" },
    { title: "Million Dollar Body Academy", image: "/images/go7/fitness.png", desc: "The signature course for building the body and mindset of a champion. Transform from the inside out.", link: "/million-dollar-body" },
    { title: "Upcoming Events", image: "/images/go7/keynote.png", desc: "In-person, live, and virtual events and experiences. See what's next and join us.", link: "/upcoming-events" },
    { title: "Partners", image: "/images/go7/group.png", desc: "Strategic partnerships, collaboration opportunities, and joint ventures.", link: "/partners" },
  ]

  const fiveCCards = [
    {
      title: "Core",
      image: "/images/go7/meditation.png",
  ...
  const productivityTools = [
    ...
    },
    {
      ...
      image: "/images/go7/corporate.png",
          ...
          <div className="max-w-7xl mx-auto">
            <div className="flex flex-col lg:flex-row gap-12 items-center mb-16">
              <div className="relative rounded-2xl overflow-hidden shadow-2xl max-w-md aspect-[3/4] flex-shrink-0">
                <Image src="/images/go7/coaching.png" alt="Krystalore Crews" fill className="object-cover" />
              </div>
        ...
        <div className="max-w-6xl mx-auto">
          ...
          <div className="grid lg:grid-cols-3 gap-8">
            <div className="relative rounded-2xl overflow-hidden shadow-2xl aspect-[3/4] group">
              <Image src="/images/go7/fitness.png" alt="Krystalore fitness training" fill className="object-cover group-hover:scale-105 transition-transform duration-500" />
            ...
            <div className="relative rounded-2xl overflow-hidden shadow-2xl aspect-[3/4] group">
              <Image src="/images/go7/group.png" alt="Krystalore group fitness class" fill className="object-cover group-hover:scale-105 transition-transform duration-500" />
              <div className="absolute bottom-0 left-0 right-0 p-6">
        ...
        <div className="max-w-6xl mx-auto">
          <div className="grid lg:grid-cols-2 gap-12 items-start">
            ...
            <div className="space-y-4">
              ...
              {[
                { icon: Heart, title: 'Movement: Healing in Motion', desc: 'Guided movement practices that help release stored tension and reconnect you with your body\'s wisdom.', color: 'text-[#F97316]', img: '/images/go7/fitness.png' },
                { icon: Brain, title: 'Compassionate Inquiry', desc: 'A gentle, trauma-informed approach to uncovering the root causes of emotional and physical patterns.', color: 'text-[#0D9488]', img: '/images/go7/coaching.png' },
                { icon: TreePine, title: 'Mindfulness Integration', desc: 'Present-moment awareness practices that build resilience and emotional regulation.', color: 'text-[#14B8A6]', img: '/images/go7/meditation.png' },
                { icon: Mountain, title: 'Retreats: Immersive Healing', desc: 'Immersive retreat experiences designed for deep somatic work in transformational settings.', color: 'text-[#F97316]', img: '/images/go7/hero.png' },
            ...
            <div className="grid grid-cols-2 gap-4">
              <div className="space-y-4">
                <div className="relative h-72 rounded-2xl overflow-hidden shadow-lg">
                  <Image src="/images/go7/portrait.png" alt="Krystalore Crews executive coach" fill className="object-cover" sizes="(max-width: 768px) 50vw, 25vw" />
                </div>
                <div className="relative h-64 rounded-2xl overflow-hidden shadow-lg">
                  <Image src="/images/go7/group.png" alt="Womens somatic healing retreat" fill className="object-cover" sizes="(max-width: 768px) 50vw, 25vw" />
                </div>
              </div>
              <div className="pt-8">
                <div className="relative h-80 rounded-2xl overflow-hidden shadow-lg">
                  <Image src="/images/go7/hero.png" alt="Krystalore Crews fitness coaching" fill className="object-cover" sizes="(max-width: 768px) 50vw, 25vw" />
                </div>
              </div>
            </div>
          </div>
      ...
      <section className="py-20 px-4 bg-[#37a6a6]" id="content">
        <div className="max-w-6xl mx-auto">
          ...
          <div className="grid md:grid-cols-3 gap-6">
            {[
              { title: 'Monday Motivation LIVE', subtitle: 'Weekly Highlight', desc: 'Start your week with fire. Mindset, motivation, and real talk to push you forward.', icon: Play, img: '/images/go7/fitness.png' },
              { title: 'Most People Quit Right Before It Gets Good', subtitle: 'Mindset Shift', desc: 'The breakthrough is closer than you think. Don\'t quit now—the best chapter is next.', icon: Flame, img: '/images/go7/hero.png' },
              { title: 'What Does All In Look Like?', subtitle: 'Going Deeper', desc: 'Going all in isn\'t about burning out—it\'s about alignment, focus, and relentless intentionality.', icon: Target, img: '/images/go7/keynote.png' },
            ...
            <div>
              ...
              <div className="bg-[#F4F1EC] rounded-2xl overflow-hidden shadow-md mb-6">
                <div className="relative h-56">
                  <Image src="/images/go7/coaching.png" alt="Strong sexy leg workouts at home" fill className="object-cover" sizes="(max-width: 1024px) 100vw, 50vw" />
                </div>
                <div className="p-6">
      ...
      <section className="py-20 px-4 bg-[#F4F1EC]" id="corporate">
        <div className="max-w-6xl mx-auto">
          ...
          <div className="grid md:grid-cols-3 gap-6 mb-12">
            <div className="relative h-64 rounded-2xl overflow-hidden shadow-lg">
              <Image src="/images/go7/corporate.png" alt="Leadership retreats with Krystalore Crews" fill className="object-cover" sizes="(max-width: 768px) 100vw, 33vw" />
              <div className="absolute inset-0 bg-gradient-to-t from-gray-900/60 to-transparent" />
              <p className="absolute bottom-4 left-4 text-white font-bold text-sm">Leadership Retreats</p>
            </div>
            <div className="relative h-64 rounded-2xl overflow-hidden shadow-lg">
              <Image src="/images/go7/group.png" alt="Corporate wellness workshops" fill className="object-cover" sizes="(max-width: 768px) 100vw, 33vw" />
              <div className="absolute inset-0 bg-gradient-to-t from-gray-900/60 to-transparent" />
              <p className="absolute bottom-4 left-4 text-white font-bold text-sm">Corporate Wellness</p>
            </div>
            <div className="relative h-64 rounded-2xl overflow-hidden shadow-lg">
              <Image src="/images/go7/keynote.png" alt="Keynote speaking and corporate events" fill className="object-cover" sizes="(max-width: 768px) 100vw, 33vw" />
              <div className="absolute inset-0 bg-gradient-to-t from-gray-900/60 to-transparent" />
      ...
      <section className="py-20 px-4 bg-white" id="media">
        <div className="max-w-6xl mx-auto">
          ...
          <div className="grid md:grid-cols-2 gap-8 mb-12 max-w-3xl mx-auto">
            <div className="relative h-72 rounded-2xl overflow-hidden shadow-lg">
              <Image src="/images/go7/keynote.png" alt="Krystalore Crews speaking at a leadership and wellness event" fill className="object-cover" sizes="(max-width: 768px) 100vw, 384px" />
            </div>
            <div className="relative h-72 rounded-2xl overflow-hidden shadow-lg">
              <Image src="/images/go7/portrait.png" alt="Krystalore Crews press and media professional photo" fill className="object-cover" sizes="(max-width: 768px) 100vw, 384px" />
            </div>
          </div>
        ...
        <div className="max-w-6xl mx-auto">
          ...
          <div className="grid md:grid-cols-3 gap-4 mb-10">
            <div className="relative h-64 rounded-xl overflow-hidden shadow-md">
              <Image src="/images/go7/meditation.png" alt="Wellness lifestyle and self-care products" fill className="object-cover" sizes="(max-width: 768px) 100vw, 33vw" />
              <div className="absolute inset-0 bg-gradient-to-t from-gray-900/50 to-transparent" />
              <p className="absolute bottom-3 left-3 text-white font-bold text-sm">Wellness Collection</p>
            </div>
            <div className="relative h-64 rounded-xl overflow-hidden shadow-md">
              <Image src="/images/go7/hero.png" alt="Beyond Limits lifestyle and activewear" fill className="object-cover" sizes="(max-width: 768px) 100vw, 33vw" />
              <div className="absolute inset-0 bg-gradient-to-t from-gray-900/50 to-transparent" />
              <p className="absolute bottom-3 left-3 text-white font-bold text-sm">Lifestyle</p>
            </div>
            <div className="relative h-64 rounded-xl overflow-hidden shadow-md">
              <Image src="/images/go7/fitness.png" alt="Beyond Limits merchandise and apparel" fill className="object-cover" sizes="(max-width: 768px) 100vw, 33vw" />
              <div className="absolute inset-0 bg-gradient-to-t from-gray-900/50 to-transparent" />
