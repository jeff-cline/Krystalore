    ...
    <>
      ...
      <section className="relative overflow-hidden min-h-screen flex items-center">
        ...
        <div className="container mx-auto px-4 relative z-10 py-20 md:py-28">
          ...
          <div className="flex flex-col sm:flex-row gap-4">
            <a href="https://krystalorecrews.com" target="_blank" rel="noopener noreferrer" className="bg-[#34c5c5] text-white rounded-full px-8 py-4 font-bold hover:scale-105 transition-transform text-center shadow-lg">Join on KrystaloreCrews.com</a>
      ...
      <section className="py-24 bg-gradient-to-br from-orange-500 to-orange-600 text-white">
        <div className="max-w-4xl mx-auto px-6 text-center">
          ...
          <a href="https://krystalorecrews.com" target="_blank" rel="noopener noreferrer" className="inline-block bg-white text-orange-600 font-bold rounded-xl px-10 py-5 text-lg hover:bg-gray-100 transition-all">Join the Crew</a>
