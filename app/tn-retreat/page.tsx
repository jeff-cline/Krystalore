...
const itinerary = [
  ...
  { day: 'Day 7', title: 'Integration & Departure', icon: Waves, desc: 'Close with integration, gratitude, and a grounded plan for returning home renewed, steady, and ready for what is next.' },
]
