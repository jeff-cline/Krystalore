...
const STYLES: Record<NonNullable<MailtoCTAProps['variant']>, string> = {
  primary:
    'bg-[#006767] hover:bg-[#005555] text-white font-bold py-4 px-8 rounded-xl transition-colors text-lg shadow-lg shadow-[#006767]/30 inline-flex items-center justify-center gap-2',
  secondary:
    'bg-gray-900 hover:bg-black text-white font-bold py-4 px-8 rounded-xl transition-colors inline-flex items-center justify-center gap-2',
  ghost:
    'text-[#006767] hover:text-[#004d4d] font-semibold underline underline-offset-2 inline-flex items-center gap-2',
}
