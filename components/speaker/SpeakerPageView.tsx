...
function VideoLibrary({ categories }: { categories: SpeakerVideoCategory[] }) {
...
export default function SpeakerPageView({ content }: { content: SpeakerContent }) {
  return (
    <>
      <JsonLd />
      <PageFrame
